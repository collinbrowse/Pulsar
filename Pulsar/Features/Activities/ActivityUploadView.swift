...
struct ActivityUploadView: View {
        ...
        NavigationStack {
            VStack(spacing: 32) {
                ...
                VStack(spacing: 8) {
                    ...
                    HStack(spacing: 16) {
                        UploadFormatBadge(name: "GPX")
                        UploadFormatBadge(name: "TCX")
                        UploadFormatBadge(name: "FIT")
                    }
                }
                .padding(.bottom, 32)
            }
            ...
            .alert("Activity Imported!", isPresented: $showSuccess) {
                Button("View Activity") {
                    // Future: deep link to activity detail; dismiss for now
                    dismiss()
                }
    ...
    private func importFromHealthKit() {
        // HealthKit import is planned; surface a clear placeholder for now
